...
class HybridRecognitionDataset(HybridDatasetBase):
    def __init__(self, dataset_dir, tokenizer, clip_image_encoder, epoch_samples=10000, batch_size=2,
                 precision="fp32",dataset="SFEW_recog_dataset||CAER-S_recog_dataset", validation=False, sample_rate=None):
        datasets_config = {"SFEW_recog_dataset": SFEW_EmoRecog_Dataset,
...
class HybridReconstructionDataset(HybridDatasetBase):
    def __init__(self, dataset_dir, tokenizer, clip_image_encoder, epoch_samples=10000, batch_size=2,
                 precision="fp32", dataset="SFEW_recon_dataset||CAER-S_recon_dataset", validation=False, sample_rate=None):
        datasets_config = {"SFEW_recon_dataset": SFEW_ExpRecon_Dataset,
